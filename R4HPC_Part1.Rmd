...
* Open <br><br>`R4HPC_Part1.html` <br><br> in your web browser
...
ACLF Theta KNL- Intel-Cray XC40
...
## Part I: **Environment and Workflow**
## Part II: Parallel Hardware and Software Overview
## Part III: Shared Memory Tools
## Part IV: Distributed Memory Tools
---
...
**Packages:** (from CRAN, or if prefixed with RBigData use `remotes::install_github("RBigData/packagename")` ) <br>
Day 1: flexiblas, <br>
Day 2: RBigData/pbdMPI, RBigData/kazaam, RBigData/pbdDMAT
...
```{r echo=FALSE, out.height=10, out.width=280}
...
* **module** to set software environment (PATH)
  * <mark>*module load R*</mark> (Theta ALCF, )
  * <mark>*module load r*</mark> (Andes OLCF, )
  * <mark>*module list*</mark>
  * <mark>*module avail*</mark>
  
---
## Hands-on Session 1
* Fork R4HPCcode to your GitHub account
   * Login to GitHub
   * Navigate to RBigData/R4HPCcode repository
   * Click Fork button near top-right
* Clone to New Project in RStudio
* Open Terminal window (ssh or putty)
* Login to cluster
* clone your R4HPCcode (git clone ...)
...
.pull-left[
```{r echo=FALSE, out.height=300, fig.align='center', fig.alt="Photo used in many HPC presentations and seems to originate on Reddit"}
knitr::include_graphics("pics/WSC/iDVTstR_theory.jpg")
```
]
.pull-right[
```{r echo=FALSE, out.height=300, fig.align='center', fig.align='center', fig.alt="Photo used in many HPC presentations and seems to originate on Reddit"}
...
## Faster BLAS For Faster R on your macOS Laptop
...
```
---
## FlexiBLAS For BLAS Control on your macOS Laptop
